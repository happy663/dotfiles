---
name: task-research
description: タスクについて詳細に調査し、構造化されたまとめを出力する。ultrathinkモードで深く考察し、背景、期限、過去の対応方法、確認事項を調査。すべての情報に出典リンクを明記し、推測は必ず明示する。
argument-hint: "[タスク内容]"
...
タスクについて、ultrathinkモードで深く考察し、詳細に調査します。

## 調査項目

以下の項目について調査し、構造化されたまとめを出力します:
